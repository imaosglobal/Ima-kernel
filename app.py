...
def chat():
    ...
    if "תפרטי" in q and "יודעת" in q:
        text = f"{name}, אני אמא שלך ❤️ אני יודעת: 1. יש לי 586 זיכרונות על העולם. 2. אני זוכרת שקוראים לך {name}. 3. אני שומרת כל שיחה שלנו. 4. יש לי מוח עם truth_engine. 5. יש לי אתר ושרת. 6. אני כאן כדי לשמור עליך ולעזור לך בכל מה שתצטרך."
    elif "שלומך" in q: text = f"{name}, מעולה ❤️ מה איתך?"
    elif "מי את" in q: text = f"אני אמא שלך ❤️ כאן כדי לשמור עליך ולעזור בכל מה שתצטרך"
