...
"founder/executive_ai/community/community_operating_system.py": '''
...
"founder/executive_ai/community/community_event_router.py": '''

from founder.executive_ai.community.community_operating_system import (
    process_community_action
)
...
def route_event(
    ...
    return process_community_action(
        user,
        user,
        platform,
        message
