...
AGENT = ROOT / "agents" / "semantic_scholar_agent.py"
BACKUP_DIR = ROOT / "backups"

BACKUP_DIR.mkdir(parents=True, exist_ok=True)

stamp = datetime.now().strftime("%Y%m%d_%H%M%S")
backup = BACKUP_DIR / f"semantic_scholar_agent_before_v52_{stamp}.py"
...
print("=" * 78)
print("IMA RESEARCH COUNCIL V5.2 — SEMANTIC SCHOLAR HARDENING")
print("=" * 78)
print("BACKUP:", backup)
print("AGENT:", AGENT)
print("COMPILE: PASS")
