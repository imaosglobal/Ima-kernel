...
_CONTRACT = Path(file).resolve().parents[1] / "UNIVERSAL_ADAPTER_CONTRACT.py"
...
def execute(self, action, payload=None):
    ...
    if body is not None and method in {
        "POST",
        "PUT",
        "PATCH",
        "DELETE",
    ...
    for attempt in range(retries + 1):
        ...
        try:
            ...
            if marker_pos >= 0:
                ...
                body_part = raw[:marker_pos]
                metadata = raw[marker_pos:].splitlines()
