...
try:
    from self_awareness.lesson_engine import learn
    LESSON_ENGINE=True
except Exception:
    learn=None
    LESSON_ENGINE=False
...
# ============================================================
# SELF AWARENESS SYSTEM MEMORY
# ============================================================
try:
    from self_awareness.system_memory import human_summary
    SYSTEM_MEMORY=True
except Exception:
    human_summary=None
    SYSTEM_MEMORY=False
...
class IMAMaster:
    ...
    def ask(self,message):
        ...
        # ============================================================
        # REAL TOP PRIORITY BRIDGE STATUS
        # ============================================================

        if "bridge_direct_status" in message.lower():
            try:
                from self_awareness.bridge.status_api import status
        ...
        # ============================================================
        # SELF AWARENESS EVENT: MESSAGE RECEIVED
        # ============================================================
        try:
        ...
        # ============================================================
        # SELF AWARENESS MEMORY SUMMARY COMMANDS
        # ============================================================
        ...
        if SYSTEM_MEMORY and any(
            cmd.lower() in message.lower()
            for cmd in summary_commands
        ):
            result["response"] = human_summary()
            return result


        # ============================================================
        # SELF AWARENESS LESSON COMMANDS
        # ============================================================
        ...
        if LESSON_ENGINE and any(
            cmd.lower() in message.lower()
            for cmd in lesson_commands
        ):
            lessons = learn()
        ...
        # ============================================================
        # SELF AWARENESS KNOWLEDGE QUERY COMMANDS
        # ============================================================
        ...
        if any(
            ...
            try:
                from self_awareness.knowledge_query import answer
        ...
        if any(
            ...
            try:
                from self_awareness.self_diagnosis import human

                result["response"]=human()
        ...
        # ============================================================
        # DIRECT BRIDGE STATUS COMMAND
        # ============================================================

        if "bridge_direct_status" in message.lower():
            print(">>> BRIDGE GATE HIT")
            try:
                from self_awareness.bridge.status_api import status
        ...
        if any(
            ...
            try:
                from self_awareness.bridge.sender import send_pending
        ...
        # ============================================================
        # SELF AWARENESS EVENT: RESPONSE GENERATED
        # ============================================================
        try:
            from self_awareness.event_bridge import emit
            ...
            emit(
                ...
                {
                    "source":"IMA.ask",
                    "length":len(str(result.get("response","")))
                }
            )
        ...
        # ============================================================
        try:
            from self_awareness.reflection_engine import analyze
        ...
        # ============================================================
        # AUTO KNOWLEDGE CONSOLIDATION
        # ============================================================
        try:
            from self_awareness.knowledge_consolidator import consolidate

            knowledge = consolidate()

            result["system_knowledge"] = knowledge
        ...
        # ============================================================
        try:
            from self_awareness.report_generator import create_report
